...
// TestChain is a testing struct that wraps a novaApp with the last TM Header, the current ABCI
...
// and signer array. It also initializes 2 Sender accounts with a balance of 10000000000000000000 coins of
// bond denom and aphoton to use for tests.
//
...
func NewTestChainWithValSet(t *testing.T, coord *Coordinator, chainID string, valSet *tmtypes.ValidatorSet, signers map[string]tmtypes.PrivValidator) *TestChain {
	...
	testApp := app.SetupWithGenesisValSet(t, valSet, genAccs, chainID, genBals...)
