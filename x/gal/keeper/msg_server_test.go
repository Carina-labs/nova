...
// 	record1, err := suite.chainA.App.GalKeeper.GetRecordedDepositAmt(suite.chainA.GetContext(), hostId, receiver1.GetAddress())
// 	record2, err := suite.chainA.App.GalKeeper.GetRecordedDepositAmt(suite.chainA.GetContext(), hostId, receiver2.GetAddress())
// 	record3, err := suite.chainA.App.GalKeeper.GetRecordedDepositAmt(suite.chainA.GetContext(), hostId, receiver3.GetAddress())
// 	fmt.Printf("record: %s\n", record1.String())
// 	fmt.Printf("record: %s\n", record2.String())
// 	fmt.Printf("record: %s\n", record3.String())
