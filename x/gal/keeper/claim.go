...
func (k Keeper) ClaimAndMintShareToken(ctx sdk.Context, claimer sdk.AccAddress, amt sdk.Coin) error {
	...
	err = k.MintShareTokens(ctx, claimer, sdk.NewCoin(stAsset, sdk.NewIntFromBigInt(mintAmt)))
	if err != nil {
		return err
	}
