...
func (suite *KeeperTestSuite) SetWithdrawRecords(zoneId, withdrawer string, amount sdk.Coin, state int64, time time.Time) {
...
func (suite *KeeperTestSuite) TestGetTotalWithdrawAmountForZoneId() {
	...
	suite.SetWithdrawRecords("gaia", "test1", sdk.NewCoin("stake", sdk.NewInt(1000)), int64(1),
	...
	suite.SetWithdrawRecords("gaia", "test2", sdk.NewCoin("stake", sdk.NewInt(2000)), int64(2),
	...
	suite.SetWithdrawRecords("gaia", "test3", sdk.NewCoin("stake", sdk.NewInt(500)), int64(1),
		time.Date(time.Now().Year(), time.Now().UTC().Month(), time.Now().UTC().Day(), time.Now().UTC().Hour()-1, time.Now().UTC().Minute(), time.Now().UTC().Second(), time.Now().UTC().Nanosecond(), time.UTC))
	suite.SetWithdrawRecords("gaia", "test4", sdk.NewCoin("stake", sdk.NewInt(700)), int64(2),
		time.Date(time.Now().Year(), time.Now().UTC().Month(), time.Now().UTC().Day(), time.Now().UTC().Hour(), time.Now().UTC().Minute(), time.Now().UTC().Second(), time.Now().UTC().Nanosecond(), time.UTC))
