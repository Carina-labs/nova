...
var (
	...
	fd_RegisteredZone_connection_info   protoreflect.FieldDescriptor
	fd_RegisteredZone_validator_address protoreflect.FieldDescriptor
	fd_RegisteredZone_local_denom       protoreflect.FieldDescriptor
...
func (x *fastReflection_RegisteredZone) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.ConnectionInfo != nil {
		value := protoreflect.ValueOfMessage(x.ConnectionInfo.ProtoReflect())
		if !f(fd_RegisteredZone_connection_info, value) {
			return
		}
	}
	...
	if x.LocalDenom != "" {
		value := protoreflect.ValueOfString(x.LocalDenom)
		if !f(fd_RegisteredZone_local_denom, value) {
			return
		}
	}
	if x.AuthzAddress != "" {
...
func (x *fastReflection_RegisteredZone) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		_ = l
		if x.ConnectionInfo != nil {
			l = options.Size(x.ConnectionInfo)
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.LocalDenom) > 0 {
			i -= len(x.LocalDenom)
			copy(dAtA[i:], x.LocalDenom)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.LocalDenom)))
			i--
			dAtA[i] = 0x1a
		}
		...
		if x.ConnectionInfo != nil {
			encoded, err := options.Marshal(x.ConnectionInfo)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 1:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field ConnectionInfo", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if x.ConnectionInfo == nil {
					x.ConnectionInfo = &IcaConnectionInfo{}
				}
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.ConnectionInfo); err != nil {
			...
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field LocalDenom", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.LocalDenom = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 4:
				if wireType != 2 {
...
var (
	...
	fd_IcaConnectionInfo_zone_name     protoreflect.FieldDescriptor
...
func (x *fastReflection_IcaConnectionInfo) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.ZoneName != "" {
		value := protoreflect.ValueOfString(x.ZoneName)
		if !f(fd_IcaConnectionInfo_zone_name, value) {
			return
		}
	}
	if x.ConnectionId != "" {
...
type RegisteredZone struct {
	...
	AuthzAddress     string             `protobuf:"bytes,4,opt,name=authz_address,json=authzAddress,proto3" json:"authz_address,omitempty"` //repeated string authz_permit = 5;
}
...
func (x *RegisteredZone) GetLocalDenom() string {
	if x != nil {
		return x.LocalDenom
	}
	return ""
