...
var _ protoreflect.List = (*_DepositRecord_2_list)(nil)

type _DepositRecord_2_list struct {
	list *[]*DepositRecordContent
}

func (x *_DepositRecord_2_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_DepositRecord_2_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_DepositRecord_2_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*DepositRecordContent)
	(*x.list)[i] = concreteValue
}

func (x *_DepositRecord_2_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*DepositRecordContent)
	*x.list = append(*x.list, concreteValue)
}

func (x *_DepositRecord_2_list) AppendMutable() protoreflect.Value {
	v := new(DepositRecordContent)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_DepositRecord_2_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_DepositRecord_2_list) NewElement() protoreflect.Value {
	v := new(DepositRecordContent)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_DepositRecord_2_list) IsValid() bool {
	return x.list != nil
}
...
func (x *fastReflection_DepositRecord) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.Records) != 0 {
		value := protoreflect.ValueOfList(&_DepositRecord_2_list{list: &x.Records})
...
func (x *fastReflection_DepositRecord) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "nova.gal.v1.DepositRecord.records":
		if len(x.Records) == 0 {
			return protoreflect.ValueOfList(&_DepositRecord_2_list{})
		}
		listValue := &_DepositRecord_2_list{list: &x.Records}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.gal.v1.DepositRecord"))
...
func (x *fastReflection_DepositRecord) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "nova.gal.v1.DepositRecord.records":
		...
		value := &_DepositRecord_2_list{list: &x.Records}
		return protoreflect.ValueOfList(value)
	case "nova.gal.v1.DepositRecord.address":
...
func (x *fastReflection_DepositRecord) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "nova.gal.v1.DepositRecord.records":
		list := []*DepositRecordContent{}
		return protoreflect.ValueOfList(&_DepositRecord_2_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.gal.v1.DepositRecord"))
		}
...
var (
	...
	fd_DepositRecordContent_zone_id       protoreflect.FieldDescriptor
	fd_DepositRecordContent_amount        protoreflect.FieldDescriptor
	fd_DepositRecordContent_isTransferred protoreflect.FieldDescriptor
)

func init() {
	file_nova_gal_v1_genesis_proto_init()
	md_DepositRecordContent = File_nova_gal_v1_genesis_proto.Messages().ByName("DepositRecordContent")
	fd_DepositRecordContent_zone_id = md_DepositRecordContent.Fields().ByName("zone_id")
	fd_DepositRecordContent_amount = md_DepositRecordContent.Fields().ByName("amount")
	fd_DepositRecordContent_isTransferred = md_DepositRecordContent.Fields().ByName("isTransferred")
}
...
func (x *fastReflection_DepositRecordContent) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.ZoneId != "" {
		...
		if !f(fd_DepositRecordContent_zone_id, value) {
			return
		}
	}
	if x.Amount != nil {
	...
	if x.IsTransferred != false {
		...
		if !f(fd_DepositRecordContent_isTransferred, value) {
			return
		}
	}
}
...
func (x *fastReflection_DepositRecordContent) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "nova.gal.v1.DepositRecordContent.zone_id":
		return x.ZoneId != ""
	case "nova.gal.v1.DepositRecordContent.amount":
		return x.Amount != nil
	case "nova.gal.v1.DepositRecordContent.isTransferred":
...
func (x *fastReflection_DepositRecordContent) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "nova.gal.v1.DepositRecordContent.zone_id":
		panic(fmt.Errorf("field zone_id of message nova.gal.v1.DepositRecordContent is not mutable"))
	case "nova.gal.v1.DepositRecordContent.isTransferred":
		panic(fmt.Errorf("field isTransferred of message nova.gal.v1.DepositRecordContent is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.gal.v1.DepositRecordContent"))
		}
...
type DepositRecord struct {
	...
	Address string                  `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
	Records []*DepositRecordContent `protobuf:"bytes,2,rep,name=records,proto3" json:"records,omitempty"`
}
...
type DepositRecordContent struct {
	...
	IsTransferred bool          `protobuf:"varint,3,opt,name=isTransferred,proto3" json:"isTransferred,omitempty"`
}
...
func (x *DepositRecordContent) GetZoneId() string {
	if x != nil {
		return x.ZoneId
	}
	return ""
...
func (x *DepositRecordContent) GetIsTransferred() bool {
	if x != nil {
...
var file_nova_gal_v1_genesis_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x64, 0x65, 0x62, 0x74, 0x22, 0x66, 0x0a,
	0x0d, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x18,
	0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x3b, 0x0a, 0x07, 0x72, 0x65, 0x63, 0x6f,
	0x72, 0x64, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x6e, 0x6f, 0x76, 0x61,
	...
	,
	...
	0x03, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x4d, 0x0a, 0x0f, 0x63, 0x6f, 0x6d,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x92, 0x01, 0x0a, 0x10, 0x55, 0x6e, 0x64,
	0x65, 0x6c, 0x65, 0x67, 0x61, 0x74, 0x65, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x17, 0x0a,
	0x07, 0x7a, 0x6f, 0x6e, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06,
	0x7a, 0x6f, 0x6e, 0x65, 0x49, 0x64, 0x12, 0x1c, 0x0a, 0x09, 0x64, 0x65, 0x6c, 0x65, 0x67, 0x61,
	0x74, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x64, 0x65, 0x6c, 0x65, 0x67,
	0x61, 0x74, 0x6f, 0x72, 0x12, 0x31, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0xff, 0x01,
	...
	0x09, 0x52, 0x06, 0x7a, 0x6f, 0x6e, 0x65, 0x49, 0x64, 0x12, 0x1e, 0x0a, 0x0a, 0x77, 0x69, 0x74,
	0x68, 0x64, 0x72, 0x61, 0x77, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x77,
	...
	0x63, 0x69, 0x70, 0x69, 0x65, 0x6e, 0x74, 0x12, 0x31, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e,
	0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73,
	0x2e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x43, 0x6f,
	0x69, 0x6e, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x74,
	...
	0xa0, 0x01, 0x0a, 0x0f, 0x63, 0x6f, 0x6d, 0x2e, 0x6e, 0x6f, 0x76, 0x61, 0x2e, 0x67, 0x61, 0x6c,
...
var file_nova_gal_v1_genesis_proto_depIdxs = []int32{
	...
	5,  // 2: nova.gal.v1.GenesisState.withdrawInfo:type_name -> nova.gal.v1.WithdrawInfo
