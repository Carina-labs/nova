...
var file_nova_gal_v1_query_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x32, 0xf3, 0x13, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x72, 0x79,
	...
	0x6f, 0x6e, 0x2f, 0x7b, 0x7a, 0x6f, 0x6e, 0x65, 0x5f, 0x69, 0x64, 0x7d, 0x42, 0x9e, 0x01, 0x0a,
...
var file_nova_gal_v1_query_proto_msgTypes = make([]protoimpl.MessageInfo, 32)
var file_nova_gal_v1_query_proto_goTypes = []interface{}{
	...
	(*Params)(nil),                                // 32: nova.gal.v1.Params
	(*v1beta1.Coin)(nil),                          // 33: cosmos.base.v1beta1.Coin
	(*DepositRecord)(nil),                         // 34: nova.gal.v1.DepositRecord
	(*DelegateRecord)(nil),                        // 35: nova.gal.v1.DelegateRecord
	(*UndelegateRecord)(nil),                      // 36: nova.gal.v1.UndelegateRecord
	(*WithdrawRecord)(nil),                        // 37: nova.gal.v1.WithdrawRecord
	(*IBCTrace)(nil),                              // 38: nova.gal.v1.IBCTrace
}
var file_nova_gal_v1_query_proto_depIdxs = []int32{
	32, // 0: nova.gal.v1.QueryParamsResponse.params:type_name -> nova.gal.v1.Params
	33, // 1: nova.gal.v1.QueryClaimableAmountResponse.amount:type_name -> cosmos.base.v1beta1.Coin
	33, // 2: nova.gal.v1.QueryPendingWithdrawalsResponse.amount:type_name -> cosmos.base.v1beta1.Coin
	33, // 3: nova.gal.v1.QueryDepositAmountResponse.amount:type_name -> cosmos.base.v1beta1.Coin
	33, // 4: nova.gal.v1.QueryActiveWithdrawalsResponse.amount:type_name -> cosmos.base.v1beta1.Coin
	34, // 5: nova.gal.v1.QueryDepositRecordResponse.deposit_record:type_name -> nova.gal.v1.DepositRecord
	35, // 6: nova.gal.v1.QueryDelegateRecordResponse.delegateRecord:type_name -> nova.gal.v1.DelegateRecord
	36, // 7: nova.gal.v1.QueryUndelegateRecordResponse.undelegate_record:type_name -> nova.gal.v1.UndelegateRecord
	37, // 8: nova.gal.v1.QueryWithdrawRecordResponse.withdraw_record:type_name -> nova.gal.v1.WithdrawRecord
	33, // 9: nova.gal.v1.QueryEstimateSnAssetResponse.amount:type_name -> cosmos.base.v1beta1.Coin
	38, // 10: nova.gal.v1.QueryDelegateVersionResponse.version_info:type_name -> nova.gal.v1.IBCTrace
	38, // 11: nova.gal.v1.QueryUndelegateVersionResponse.version_info:type_name -> nova.gal.v1.IBCTrace
	38, // 12: nova.gal.v1.QueryWithdrawVersionResponse.version_info:type_name -> nova.gal.v1.IBCTrace
	0,  // 13: nova.gal.v1.Query.Params:input_type -> nova.gal.v1.QueryParamsRequest
	18, // 14: nova.gal.v1.Query.EstimateSnAsset:input_type -> nova.gal.v1.QueryEstimateSnAssetRequest
	2,  // 15: nova.gal.v1.Query.ClaimableAmount:input_type -> nova.gal.v1.QueryClaimableAmountRequest
	6,  // 16: nova.gal.v1.Query.DepositAmount:input_type -> nova.gal.v1.QueryDepositAmountRequest
	4,  // 17: nova.gal.v1.Query.PendingWithdrawals:input_type -> nova.gal.v1.QueryPendingWithdrawalsRequest
	8,  // 18: nova.gal.v1.Query.ActiveWithdrawals:input_type -> nova.gal.v1.QueryActiveWithdrawalsRequest
	10, // 19: nova.gal.v1.Query.DepositRecords:input_type -> nova.gal.v1.QueryDepositRecordRequest
	12, // 20: nova.gal.v1.Query.DelegateRecords:input_type -> nova.gal.v1.QueryDelegateRecordRequest
	14, // 21: nova.gal.v1.Query.UndelegateRecords:input_type -> nova.gal.v1.QueryUndelegateRecordRequest
	16, // 22: nova.gal.v1.Query.WithdrawRecords:input_type -> nova.gal.v1.QueryWithdrawRecordRequest
	20, // 23: nova.gal.v1.Query.DelegateVersion:input_type -> nova.gal.v1.QueryDelegateVersion
	22, // 24: nova.gal.v1.Query.UndelegateVersion:input_type -> nova.gal.v1.QueryUndelegateVersion
	24, // 25: nova.gal.v1.Query.WithdrawVersion:input_type -> nova.gal.v1.QueryWithdrawVersion
	26, // 26: nova.gal.v1.Query.DelegateCurrentVersion:input_type -> nova.gal.v1.QueryCurrentDelegateVersion
	28, // 27: nova.gal.v1.Query.UndelegateCurrentVersion:input_type -> nova.gal.v1.QueryCurrentUndelegateVersion
	30, // 28: nova.gal.v1.Query.WithdrawCurrentVersion:input_type -> nova.gal.v1.QueryCurrentWithdrawVersion
	1,  // 29: nova.gal.v1.Query.Params:output_type -> nova.gal.v1.QueryParamsResponse
	19, // 30: nova.gal.v1.Query.EstimateSnAsset:output_type -> nova.gal.v1.QueryEstimateSnAssetResponse
	3,  // 31: nova.gal.v1.Query.ClaimableAmount:output_type -> nova.gal.v1.QueryClaimableAmountResponse
	7,  // 32: nova.gal.v1.Query.DepositAmount:output_type -> nova.gal.v1.QueryDepositAmountResponse
	5,  // 33: nova.gal.v1.Query.PendingWithdrawals:output_type -> nova.gal.v1.QueryPendingWithdrawalsResponse
	9,  // 34: nova.gal.v1.Query.ActiveWithdrawals:output_type -> nova.gal.v1.QueryActiveWithdrawalsResponse
	11, // 35: nova.gal.v1.Query.DepositRecords:output_type -> nova.gal.v1.QueryDepositRecordResponse
	13, // 36: nova.gal.v1.Query.DelegateRecords:output_type -> nova.gal.v1.QueryDelegateRecordResponse
	15, // 37: nova.gal.v1.Query.UndelegateRecords:output_type -> nova.gal.v1.QueryUndelegateRecordResponse
	17, // 38: nova.gal.v1.Query.WithdrawRecords:output_type -> nova.gal.v1.QueryWithdrawRecordResponse
	21, // 39: nova.gal.v1.Query.DelegateVersion:output_type -> nova.gal.v1.QueryDelegateVersionResponse
	23, // 40: nova.gal.v1.Query.UndelegateVersion:output_type -> nova.gal.v1.QueryUndelegateVersionResponse
	25, // 41: nova.gal.v1.Query.WithdrawVersion:output_type -> nova.gal.v1.QueryWithdrawVersionResponse
	27, // 42: nova.gal.v1.Query.DelegateCurrentVersion:output_type -> nova.gal.v1.QueryCurrentDelegateVersionResponse
	29, // 43: nova.gal.v1.Query.UndelegateCurrentVersion:output_type -> nova.gal.v1.QueryCurrentUndelegateVersionResponse
	31, // 44: nova.gal.v1.Query.WithdrawCurrentVersion:output_type -> nova.gal.v1.QueryCurrentWithdrawVersionResponse
