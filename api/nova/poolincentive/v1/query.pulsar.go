...
var (
	...
	fd_QuerySingleIncentivePoolResponse_weight       protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_QuerySingleIncentivePoolResponse_weight = md_QuerySingleIncentivePoolResponse.Fields().ByName("weight")
}
...
func (x *fastReflection_QuerySingleIncentivePoolResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Weight != "" {
		...
		if !f(fd_QuerySingleIncentivePoolResponse_weight, value) {
			return
		}
	}
}
...
func (x *fastReflection_QuerySingleIncentivePoolResponse) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "nova.poolincentive.v1.QuerySingleIncentivePoolResponse.pool_address":
		return x.PoolAddress != ""
	case "nova.poolincentive.v1.QuerySingleIncentivePoolResponse.weight":
		return x.Weight != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_QuerySingleIncentivePoolResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "nova.poolincentive.v1.QuerySingleIncentivePoolResponse.weight":
		panic(fmt.Errorf("field weight of message nova.poolincentive.v1.QuerySingleIncentivePoolResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.poolincentive.v1.QuerySingleIncentivePoolResponse"))
		}
...
var (
	md_QueryTotalWeightRequest protoreflect.MessageDescriptor
)

func init() {
	file_nova_poolincentive_v1_query_proto_init()
	md_QueryTotalWeightRequest = File_nova_poolincentive_v1_query_proto.Messages().ByName("QueryTotalWeightRequest")
}

var _ protoreflect.Message = (*fastReflection_QueryTotalWeightRequest)(nil)

type fastReflection_QueryTotalWeightRequest QueryTotalWeightRequest

func (x *QueryTotalWeightRequest) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryTotalWeightRequest)(x)
}

func (x *QueryTotalWeightRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_nova_poolincentive_v1_query_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_QueryTotalWeightRequest_messageType fastReflection_QueryTotalWeightRequest_messageType
var _ protoreflect.MessageType = fastReflection_QueryTotalWeightRequest_messageType{}

type fastReflection_QueryTotalWeightRequest_messageType struct{}

func (x fastReflection_QueryTotalWeightRequest_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryTotalWeightRequest)(nil)
}
func (x fastReflection_QueryTotalWeightRequest_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryTotalWeightRequest)
}
func (x fastReflection_QueryTotalWeightRequest_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryTotalWeightRequest
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryTotalWeightRequest) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryTotalWeightRequest
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryTotalWeightRequest) Type() protoreflect.MessageType {
	return _fastReflection_QueryTotalWeightRequest_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryTotalWeightRequest) New() protoreflect.Message {
	return new(fastReflection_QueryTotalWeightRequest)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryTotalWeightRequest) Interface() protoreflect.ProtoMessage {
	return (*QueryTotalWeightRequest)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryTotalWeightRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryTotalWeightRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.poolincentive.v1.QueryTotalWeightRequest"))
		}
		panic(fmt.Errorf("message nova.poolincentive.v1.QueryTotalWeightRequest does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryTotalWeightRequest) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.poolincentive.v1.QueryTotalWeightRequest"))
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryTotalWeightRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.poolincentive.v1.QueryTotalWeightRequest"))
		}
		panic(fmt.Errorf("message nova.poolincentive.v1.QueryTotalWeightRequest does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryTotalWeightRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.poolincentive.v1.QueryTotalWeightRequest"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryTotalWeightRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.poolincentive.v1.QueryTotalWeightRequest"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryTotalWeightRequest) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.poolincentive.v1.QueryTotalWeightRequest"))
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryTotalWeightRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in nova.poolincentive.v1.QueryTotalWeightRequest", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryTotalWeightRequest) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryTotalWeightRequest) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryTotalWeightRequest) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryTotalWeightRequest) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryTotalWeightRequest)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryTotalWeightRequest: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryTotalWeightRequest: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			default:
				iNdEx = preIndex
...
var (
	md_QueryTotalWeightResponse              protoreflect.MessageDescriptor
	fd_QueryTotalWeightResponse_total_weight protoreflect.FieldDescriptor
)

func init() {
	file_nova_poolincentive_v1_query_proto_init()
	md_QueryTotalWeightResponse = File_nova_poolincentive_v1_query_proto.Messages().ByName("QueryTotalWeightResponse")
	fd_QueryTotalWeightResponse_total_weight = md_QueryTotalWeightResponse.Fields().ByName("total_weight")
}

var _ protoreflect.Message = (*fastReflection_QueryTotalWeightResponse)(nil)

type fastReflection_QueryTotalWeightResponse QueryTotalWeightResponse

func (x *QueryTotalWeightResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryTotalWeightResponse)(x)
}

func (x *QueryTotalWeightResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_nova_poolincentive_v1_query_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_QueryTotalWeightResponse_messageType fastReflection_QueryTotalWeightResponse_messageType
var _ protoreflect.MessageType = fastReflection_QueryTotalWeightResponse_messageType{}

type fastReflection_QueryTotalWeightResponse_messageType struct{}

func (x fastReflection_QueryTotalWeightResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryTotalWeightResponse)(nil)
}
func (x fastReflection_QueryTotalWeightResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryTotalWeightResponse)
}
func (x fastReflection_QueryTotalWeightResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryTotalWeightResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryTotalWeightResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryTotalWeightResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryTotalWeightResponse) Type() protoreflect.MessageType {
	return _fastReflection_QueryTotalWeightResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryTotalWeightResponse) New() protoreflect.Message {
	return new(fastReflection_QueryTotalWeightResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryTotalWeightResponse) Interface() protoreflect.ProtoMessage {
	return (*QueryTotalWeightResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryTotalWeightResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.TotalWeight != uint64(0) {
		value := protoreflect.ValueOfUint64(x.TotalWeight)
		if !f(fd_QueryTotalWeightResponse_total_weight, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryTotalWeightResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "nova.poolincentive.v1.QueryTotalWeightResponse.total_weight":
		return x.TotalWeight != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.poolincentive.v1.QueryTotalWeightResponse"))
		}
		panic(fmt.Errorf("message nova.poolincentive.v1.QueryTotalWeightResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryTotalWeightResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "nova.poolincentive.v1.QueryTotalWeightResponse.total_weight":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryTotalWeightResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "nova.poolincentive.v1.QueryTotalWeightResponse.total_weight":
		value := x.TotalWeight
	...
	default:
		...
		panic(fmt.Errorf("message nova.poolincentive.v1.QueryTotalWeightResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryTotalWeightResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "nova.poolincentive.v1.QueryTotalWeightResponse.total_weight":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryTotalWeightResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "nova.poolincentive.v1.QueryTotalWeightResponse.total_weight":
		panic(fmt.Errorf("field total_weight of message nova.poolincentive.v1.QueryTotalWeightResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.poolincentive.v1.QueryTotalWeightResponse"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryTotalWeightResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "nova.poolincentive.v1.QueryTotalWeightResponse.total_weight":
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryTotalWeightResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in nova.poolincentive.v1.QueryTotalWeightResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryTotalWeightResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryTotalWeightResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryTotalWeightResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryTotalWeightResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryTotalWeightResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryTotalWeightResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryTotalWeightResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
...
func (x *QuerySingleIncentivePoolResponse) GetWeight() string {
	if x != nil {
		return x.Weight
	}
	return ""
...
func (x *QueryTotalWeightRequest) Reset() {
	*x = QueryTotalWeightRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_nova_poolincentive_v1_query_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryTotalWeightRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryTotalWeightRequest) ProtoMessage() {}

// Deprecated: Use QueryTotalWeightRequest.ProtoReflect.Descriptor instead.
func (*QueryTotalWeightRequest) Descriptor() ([]byte, []int) {
	return file_nova_poolincentive_v1_query_proto_rawDescGZIP(), []int{10}
}
...
func (x *QueryTotalWeightResponse) Reset() {
	*x = QueryTotalWeightResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_nova_poolincentive_v1_query_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryTotalWeightResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryTotalWeightResponse) ProtoMessage() {}

// Deprecated: Use QueryTotalWeightResponse.ProtoReflect.Descriptor instead.
func (*QueryTotalWeightResponse) Descriptor() ([]byte, []int) {
	return file_nova_poolincentive_v1_query_proto_rawDescGZIP(), []int{11}
}

func (x *QueryTotalWeightResponse) GetTotalWeight() uint64 {
	if x != nil {
...
var file_nova_poolincentive_v1_query_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x06, 0x70, 0x6f, 0x6f, 0x6c, 0x49, 0x64, 0x22, 0x76, 0x0a, 0x20, 0x51, 0x75, 0x65,
	...
	,
	...
	0x1d, 0x2f, 0x6e, 0x6f, 0x76, 0x61, 0x2f, 0x70, 0x6f, 0x6f, 0x6c, 0x69, 0x6e, 0x63, 0x65, 0x6e,
	0x74, 0x69, 0x76, 0x65, 0x2f, 0x76, 0x31, 0x2f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0xbc,
	0x01, 0x0a, 0x13, 0x53, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x43, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61,
	0x74, 0x65, 0x50, 0x6f, 0x6f, 0x6c, 0x12, 0x36, 0x2e, 0x6e, 0x6f, 0x76, 0x61, 0x2e, 0x70, 0x6f,
	0x6f, 0x6c, 0x69, 0x6e, 0x63, 0x65, 0x6e, 0x74, 0x69, 0x76, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x51,
	0x75, 0x65, 0x72, 0x79, 0x53, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x43, 0x61, 0x6e, 0x64, 0x69, 0x64,
	0x61, 0x74, 0x65, 0x50, 0x6f, 0x6f, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x37,
	...
	,
	...
	,
	...
	,
}
...
var file_nova_poolincentive_v1_query_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_nova_poolincentive_v1_query_proto_goTypes = []interface{}{
	...
	(*QueryTotalWeightRequest)(nil),          // 10: nova.poolincentive.v1.QueryTotalWeightRequest
	(*QueryTotalWeightResponse)(nil),         // 11: nova.poolincentive.v1.QueryTotalWeightResponse
	(*Params)(nil),                           // 12: nova.poolincentive.v1.Params
	(*CandidatePool)(nil),                    // 13: nova.poolincentive.v1.CandidatePool
	(*IncentivePool)(nil),                    // 14: nova.poolincentive.v1.IncentivePool
}
var file_nova_poolincentive_v1_query_proto_depIdxs = []int32{
	12, // 0: nova.poolincentive.v1.QueryParamsResponse.params:type_name -> nova.poolincentive.v1.Params
	13, // 1: nova.poolincentive.v1.QueryAllCandidatePoolResponse.candidate_pools:type_name -> nova.poolincentive.v1.CandidatePool
	14, // 2: nova.poolincentive.v1.QueryAllIncentivePoolResponse.incentive_pools:type_name -> nova.poolincentive.v1.IncentivePool
	...
	10, // 8: nova.poolincentive.v1.Query.TotalWeight:input_type -> nova.poolincentive.v1.QueryTotalWeightRequest
	1,  // 9: nova.poolincentive.v1.Query.Params:output_type -> nova.poolincentive.v1.QueryParamsResponse
	3,  // 10: nova.poolincentive.v1.Query.SingleCandidatePool:output_type -> nova.poolincentive.v1.QuerySingleCandidatePoolResponse
	7,  // 11: nova.poolincentive.v1.Query.AllCandidatePool:output_type -> nova.poolincentive.v1.QueryAllCandidatePoolResponse
	5,  // 12: nova.poolincentive.v1.Query.SingleIncentivePool:output_type -> nova.poolincentive.v1.QuerySingleIncentivePoolResponse
	9,  // 13: nova.poolincentive.v1.Query.AllIncentivePool:output_type -> nova.poolincentive.v1.QueryAllIncentivePoolResponse
	11, // 14: nova.poolincentive.v1.Query.TotalWeight:output_type -> nova.poolincentive.v1.QueryTotalWeightResponse
...
func file_nova_poolincentive_v1_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_nova_poolincentive_v1_query_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryTotalWeightRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_nova_poolincentive_v1_query_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryTotalWeightResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
