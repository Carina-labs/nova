...
func (x *_GenesisState_2_list) Set(i int, value protoreflect.Value) {
	...
	concreteValue := valueUnwrapped.Interface().(*ControllerAddressInfo)
...
var (
	...
	fd_GenesisState_controller_address_info protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_GenesisState_controller_address_info = md_GenesisState.Fields().ByName("controller_address_info")
}
...
func (x *fastReflection_GenesisState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.ControllerAddressInfo) != 0 {
		value := protoreflect.ValueOfList(&_GenesisState_2_list{list: &x.ControllerAddressInfo})
		if !f(fd_GenesisState_controller_address_info, value) {
			return
		}
	}
}
...
func (x *fastReflection_GenesisState) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "nova.icacontrol.v1.GenesisState.params":
		return x.Params != nil
	case "nova.icacontrol.v1.GenesisState.controller_address_info":
		return len(x.ControllerAddressInfo) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_GenesisState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "nova.icacontrol.v1.GenesisState.controller_address_info":
		...
		listValue := &_GenesisState_2_list{list: &x.ControllerAddressInfo}
...
func (x *fastReflection_GenesisState) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "nova.icacontrol.v1.GenesisState.controller_address_info":
		...
		x.ControllerAddressInfo = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.icacontrol.v1.GenesisState"))
		}
...
func (x *fastReflection_GenesisState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "nova.icacontrol.v1.GenesisState.controller_address_info":
		if x.ControllerAddressInfo == nil {
			x.ControllerAddressInfo = []*ControllerAddressInfo{}
		}
		value := &_GenesisState_2_list{list: &x.ControllerAddressInfo}
...
func (x *fastReflection_GenesisState) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if len(x.ControllerAddressInfo) > 0 {
			for _, e := range x.ControllerAddressInfo {
				l = options.Size(e)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.ControllerAddressInfo) > 0 {
			for iNdEx := len(x.ControllerAddressInfo) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.ControllerAddressInfo[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field ControllerAddressInfo", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.ControllerAddressInfo = append(x.ControllerAddressInfo, &ControllerAddressInfo{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.ControllerAddressInfo[len(x.ControllerAddressInfo)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
type GenesisState struct {
	...
	ControllerAddressInfo []*ControllerAddressInfo `protobuf:"bytes,2,rep,name=controller_address_info,json=controllerAddressInfo,proto3" json:"controller_address_info,omitempty"`
}
...
func (x *GenesisState) GetControllerAddressInfo() []*ControllerAddressInfo {
	if x != nil {
		return x.ControllerAddressInfo
	}
	return nil
}
...
var file_nova_icacontrol_v1_genesis_proto_rawDesc = []byte{
	...
	0x6d, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x23, 0x6e, 0x6f, 0x76, 0x61, 0x2f, 0x69,
	0x63, 0x61, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x2f, 0x76, 0x31, 0x2f, 0x69, 0x63, 0x61,
	0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xab, 0x01,
	...
	,
	...
	0x3a, 0x49, 0x63, 0x61, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x3a, 0x3a, 0x56, 0x31, 0x62,
...
var file_nova_icacontrol_v1_genesis_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_nova_icacontrol_v1_genesis_proto_goTypes = []interface{}{
	(*GenesisState)(nil),          // 0: nova.icacontrol.v1.GenesisState
	(*Params)(nil),                // 1: nova.icacontrol.v1.Params
	(*ControllerAddressInfo)(nil), // 2: nova.icacontrol.v1.ControllerAddressInfo
}
var file_nova_icacontrol_v1_genesis_proto_depIdxs = []int32{
	1, // 0: nova.icacontrol.v1.GenesisState.params:type_name -> nova.icacontrol.v1.Params
	2, // 1: nova.icacontrol.v1.GenesisState.controller_address_info:type_name -> nova.icacontrol.v1.ControllerAddressInfo
