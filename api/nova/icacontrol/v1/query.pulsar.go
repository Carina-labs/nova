...
var (
	md_QueryIcaGrantRequest         protoreflect.MessageDescriptor
	fd_QueryIcaGrantRequest_zone_id protoreflect.FieldDescriptor
)

func init() {
	file_nova_icacontrol_v1_query_proto_init()
	md_QueryIcaGrantRequest = File_nova_icacontrol_v1_query_proto.Messages().ByName("QueryIcaGrantRequest")
	fd_QueryIcaGrantRequest_zone_id = md_QueryIcaGrantRequest.Fields().ByName("zone_id")
}

var _ protoreflect.Message = (*fastReflection_QueryIcaGrantRequest)(nil)

type fastReflection_QueryIcaGrantRequest QueryIcaGrantRequest

func (x *QueryIcaGrantRequest) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryIcaGrantRequest)(x)
}

func (x *QueryIcaGrantRequest) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryIcaGrantRequest_messageType fastReflection_QueryIcaGrantRequest_messageType
var _ protoreflect.MessageType = fastReflection_QueryIcaGrantRequest_messageType{}

type fastReflection_QueryIcaGrantRequest_messageType struct{}

func (x fastReflection_QueryIcaGrantRequest_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryIcaGrantRequest)(nil)
}
func (x fastReflection_QueryIcaGrantRequest_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryIcaGrantRequest)
}
func (x fastReflection_QueryIcaGrantRequest_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryIcaGrantRequest
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryIcaGrantRequest) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryIcaGrantRequest
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryIcaGrantRequest) Type() protoreflect.MessageType {
	return _fastReflection_QueryIcaGrantRequest_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryIcaGrantRequest) New() protoreflect.Message {
	return new(fastReflection_QueryIcaGrantRequest)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryIcaGrantRequest) Interface() protoreflect.ProtoMessage {
	return (*QueryIcaGrantRequest)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryIcaGrantRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.ZoneId != "" {
		value := protoreflect.ValueOfString(x.ZoneId)
		if !f(fd_QueryIcaGrantRequest_zone_id, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryIcaGrantRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "nova.icacontrol.v1.QueryIcaGrantRequest.zone_id":
		return x.ZoneId != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.icacontrol.v1.QueryIcaGrantRequest"))
		}
		panic(fmt.Errorf("message nova.icacontrol.v1.QueryIcaGrantRequest does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryIcaGrantRequest) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "nova.icacontrol.v1.QueryIcaGrantRequest.zone_id":
		x.ZoneId = ""
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryIcaGrantRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "nova.icacontrol.v1.QueryIcaGrantRequest.zone_id":
		value := x.ZoneId
		return protoreflect.ValueOfString(value)
	default:
		...
		panic(fmt.Errorf("message nova.icacontrol.v1.QueryIcaGrantRequest does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryIcaGrantRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "nova.icacontrol.v1.QueryIcaGrantRequest.zone_id":
		x.ZoneId = value.Interface().(string)
	default:
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryIcaGrantRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "nova.icacontrol.v1.QueryIcaGrantRequest.zone_id":
		panic(fmt.Errorf("field zone_id of message nova.icacontrol.v1.QueryIcaGrantRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.icacontrol.v1.QueryIcaGrantRequest"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryIcaGrantRequest) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "nova.icacontrol.v1.QueryIcaGrantRequest.zone_id":
		return protoreflect.ValueOfString("")
	default:
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryIcaGrantRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in nova.icacontrol.v1.QueryIcaGrantRequest", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryIcaGrantRequest) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryIcaGrantRequest) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryIcaGrantRequest) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryIcaGrantRequest) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryIcaGrantRequest)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryIcaGrantRequest: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryIcaGrantRequest: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
var (
	md_QueryIcaGrantResponse        protoreflect.MessageDescriptor
	fd_QueryIcaGrantResponse_grants protoreflect.FieldDescriptor
)

func init() {
	file_nova_icacontrol_v1_query_proto_init()
	md_QueryIcaGrantResponse = File_nova_icacontrol_v1_query_proto.Messages().ByName("QueryIcaGrantResponse")
	fd_QueryIcaGrantResponse_grants = md_QueryIcaGrantResponse.Fields().ByName("grants")
}

var _ protoreflect.Message = (*fastReflection_QueryIcaGrantResponse)(nil)

type fastReflection_QueryIcaGrantResponse QueryIcaGrantResponse

func (x *QueryIcaGrantResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryIcaGrantResponse)(x)
}

func (x *QueryIcaGrantResponse) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryIcaGrantResponse_messageType fastReflection_QueryIcaGrantResponse_messageType
var _ protoreflect.MessageType = fastReflection_QueryIcaGrantResponse_messageType{}

type fastReflection_QueryIcaGrantResponse_messageType struct{}

func (x fastReflection_QueryIcaGrantResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryIcaGrantResponse)(nil)
}
func (x fastReflection_QueryIcaGrantResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryIcaGrantResponse)
}
func (x fastReflection_QueryIcaGrantResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryIcaGrantResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryIcaGrantResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryIcaGrantResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryIcaGrantResponse) Type() protoreflect.MessageType {
	return _fastReflection_QueryIcaGrantResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryIcaGrantResponse) New() protoreflect.Message {
	return new(fastReflection_QueryIcaGrantResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryIcaGrantResponse) Interface() protoreflect.ProtoMessage {
	return (*QueryIcaGrantResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryIcaGrantResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Grants != nil {
		value := protoreflect.ValueOfMessage(x.Grants.ProtoReflect())
		if !f(fd_QueryIcaGrantResponse_grants, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryIcaGrantResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "nova.icacontrol.v1.QueryIcaGrantResponse.grants":
		return x.Grants != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.icacontrol.v1.QueryIcaGrantResponse"))
		}
		panic(fmt.Errorf("message nova.icacontrol.v1.QueryIcaGrantResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryIcaGrantResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "nova.icacontrol.v1.QueryIcaGrantResponse.grants":
		x.Grants = nil
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryIcaGrantResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "nova.icacontrol.v1.QueryIcaGrantResponse.grants":
		value := x.Grants
		return protoreflect.ValueOfMessage(value.ProtoReflect())
	default:
		...
		panic(fmt.Errorf("message nova.icacontrol.v1.QueryIcaGrantResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryIcaGrantResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "nova.icacontrol.v1.QueryIcaGrantResponse.grants":
		x.Grants = value.Message().Interface().(*AuthzGrantInfo)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.icacontrol.v1.QueryIcaGrantResponse"))
		}
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryIcaGrantResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "nova.icacontrol.v1.QueryIcaGrantResponse.grants":
		if x.Grants == nil {
			x.Grants = new(AuthzGrantInfo)
		}
		return protoreflect.ValueOfMessage(x.Grants.ProtoReflect())
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.icacontrol.v1.QueryIcaGrantResponse"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryIcaGrantResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "nova.icacontrol.v1.QueryIcaGrantResponse.grants":
		m := new(AuthzGrantInfo)
		return protoreflect.ValueOfMessage(m.ProtoReflect())
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.icacontrol.v1.QueryIcaGrantResponse"))
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryIcaGrantResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in nova.icacontrol.v1.QueryIcaGrantResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryIcaGrantResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryIcaGrantResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryIcaGrantResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryIcaGrantResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryIcaGrantResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.Grants != nil {
			encoded, err := options.Marshal(x.Grants)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryIcaGrantResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryIcaGrantResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
				...
				if x.Grants == nil {
					x.Grants = &AuthzGrantInfo{}
				}
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.Grants); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
var (
	...
	fd_QueryAutoStakingVersion_version protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_QueryAutoStakingVersion_version = md_QueryAutoStakingVersion.Fields().ByName("version")
}
...
func (x *QueryAutoStakingVersion) slowProtoReflect() protoreflect.Message {
	mi := &file_nova_icacontrol_v1_query_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_QueryAutoStakingVersion) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Version != uint64(0) {
		...
		if !f(fd_QueryAutoStakingVersion_version, value) {
			return
		}
	}
}
...
func (x *fastReflection_QueryAutoStakingVersion) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "nova.icacontrol.v1.QueryAutoStakingVersion.zone_id":
		return x.ZoneId != ""
	case "nova.icacontrol.v1.QueryAutoStakingVersion.version":
...
func (x *fastReflection_QueryAutoStakingVersion) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "nova.icacontrol.v1.QueryAutoStakingVersion.version":
		panic(fmt.Errorf("field version of message nova.icacontrol.v1.QueryAutoStakingVersion is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.icacontrol.v1.QueryAutoStakingVersion"))
		}
...
var (
	...
	fd_QueryAutoStakingVersionResponse_version_info protoreflect.FieldDescriptor
)

func init() {
	file_nova_icacontrol_v1_query_proto_init()
	md_QueryAutoStakingVersionResponse = File_nova_icacontrol_v1_query_proto.Messages().ByName("QueryAutoStakingVersionResponse")
	fd_QueryAutoStakingVersionResponse_version_info = md_QueryAutoStakingVersionResponse.Fields().ByName("version_info")
}
...
func (x *QueryAutoStakingVersionResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_nova_icacontrol_v1_query_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_QueryAutoStakingVersionResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.VersionInfo != nil {
		...
		if !f(fd_QueryAutoStakingVersionResponse_version_info, value) {
			return
		}
	}
}
...
func (x *fastReflection_QueryAutoStakingVersionResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "nova.icacontrol.v1.QueryAutoStakingVersionResponse.version_info":
...
var (
	md_QueryCurrentAutoStakingVersion         protoreflect.MessageDescriptor
	fd_QueryCurrentAutoStakingVersion_zone_id protoreflect.FieldDescriptor
)

func init() {
	file_nova_icacontrol_v1_query_proto_init()
	md_QueryCurrentAutoStakingVersion = File_nova_icacontrol_v1_query_proto.Messages().ByName("QueryCurrentAutoStakingVersion")
	fd_QueryCurrentAutoStakingVersion_zone_id = md_QueryCurrentAutoStakingVersion.Fields().ByName("zone_id")
}

var _ protoreflect.Message = (*fastReflection_QueryCurrentAutoStakingVersion)(nil)

type fastReflection_QueryCurrentAutoStakingVersion QueryCurrentAutoStakingVersion

func (x *QueryCurrentAutoStakingVersion) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryCurrentAutoStakingVersion)(x)
}

func (x *QueryCurrentAutoStakingVersion) slowProtoReflect() protoreflect.Message {
	mi := &file_nova_icacontrol_v1_query_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_QueryCurrentAutoStakingVersion_messageType fastReflection_QueryCurrentAutoStakingVersion_messageType
var _ protoreflect.MessageType = fastReflection_QueryCurrentAutoStakingVersion_messageType{}

type fastReflection_QueryCurrentAutoStakingVersion_messageType struct{}

func (x fastReflection_QueryCurrentAutoStakingVersion_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryCurrentAutoStakingVersion)(nil)
}
func (x fastReflection_QueryCurrentAutoStakingVersion_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryCurrentAutoStakingVersion)
}
func (x fastReflection_QueryCurrentAutoStakingVersion_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryCurrentAutoStakingVersion
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryCurrentAutoStakingVersion) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryCurrentAutoStakingVersion
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryCurrentAutoStakingVersion) Type() protoreflect.MessageType {
	return _fastReflection_QueryCurrentAutoStakingVersion_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryCurrentAutoStakingVersion) New() protoreflect.Message {
	return new(fastReflection_QueryCurrentAutoStakingVersion)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryCurrentAutoStakingVersion) Interface() protoreflect.ProtoMessage {
	return (*QueryCurrentAutoStakingVersion)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryCurrentAutoStakingVersion) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.ZoneId != "" {
		value := protoreflect.ValueOfString(x.ZoneId)
		if !f(fd_QueryCurrentAutoStakingVersion_zone_id, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryCurrentAutoStakingVersion) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "nova.icacontrol.v1.QueryCurrentAutoStakingVersion.zone_id":
		return x.ZoneId != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.icacontrol.v1.QueryCurrentAutoStakingVersion"))
		}
		panic(fmt.Errorf("message nova.icacontrol.v1.QueryCurrentAutoStakingVersion does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryCurrentAutoStakingVersion) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "nova.icacontrol.v1.QueryCurrentAutoStakingVersion.zone_id":
		x.ZoneId = ""
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryCurrentAutoStakingVersion) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "nova.icacontrol.v1.QueryCurrentAutoStakingVersion.zone_id":
		value := x.ZoneId
		return protoreflect.ValueOfString(value)
	default:
		...
		panic(fmt.Errorf("message nova.icacontrol.v1.QueryCurrentAutoStakingVersion does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryCurrentAutoStakingVersion) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "nova.icacontrol.v1.QueryCurrentAutoStakingVersion.zone_id":
		x.ZoneId = value.Interface().(string)
	default:
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryCurrentAutoStakingVersion) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "nova.icacontrol.v1.QueryCurrentAutoStakingVersion.zone_id":
		panic(fmt.Errorf("field zone_id of message nova.icacontrol.v1.QueryCurrentAutoStakingVersion is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.icacontrol.v1.QueryCurrentAutoStakingVersion"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryCurrentAutoStakingVersion) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "nova.icacontrol.v1.QueryCurrentAutoStakingVersion.zone_id":
		return protoreflect.ValueOfString("")
	default:
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryCurrentAutoStakingVersion) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in nova.icacontrol.v1.QueryCurrentAutoStakingVersion", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryCurrentAutoStakingVersion) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryCurrentAutoStakingVersion) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryCurrentAutoStakingVersion) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryCurrentAutoStakingVersion) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryCurrentAutoStakingVersion)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryCurrentAutoStakingVersion: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryCurrentAutoStakingVersion: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
var (
	md_QueryCurrentAutoStakingVersionResponse         protoreflect.MessageDescriptor
	fd_QueryCurrentAutoStakingVersionResponse_version protoreflect.FieldDescriptor
)

func init() {
	file_nova_icacontrol_v1_query_proto_init()
	md_QueryCurrentAutoStakingVersionResponse = File_nova_icacontrol_v1_query_proto.Messages().ByName("QueryCurrentAutoStakingVersionResponse")
	fd_QueryCurrentAutoStakingVersionResponse_version = md_QueryCurrentAutoStakingVersionResponse.Fields().ByName("version")
}

var _ protoreflect.Message = (*fastReflection_QueryCurrentAutoStakingVersionResponse)(nil)

type fastReflection_QueryCurrentAutoStakingVersionResponse QueryCurrentAutoStakingVersionResponse

func (x *QueryCurrentAutoStakingVersionResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryCurrentAutoStakingVersionResponse)(x)
}

func (x *QueryCurrentAutoStakingVersionResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_nova_icacontrol_v1_query_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_QueryCurrentAutoStakingVersionResponse_messageType fastReflection_QueryCurrentAutoStakingVersionResponse_messageType
var _ protoreflect.MessageType = fastReflection_QueryCurrentAutoStakingVersionResponse_messageType{}

type fastReflection_QueryCurrentAutoStakingVersionResponse_messageType struct{}

func (x fastReflection_QueryCurrentAutoStakingVersionResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryCurrentAutoStakingVersionResponse)(nil)
}
func (x fastReflection_QueryCurrentAutoStakingVersionResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryCurrentAutoStakingVersionResponse)
}
func (x fastReflection_QueryCurrentAutoStakingVersionResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryCurrentAutoStakingVersionResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryCurrentAutoStakingVersionResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryCurrentAutoStakingVersionResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryCurrentAutoStakingVersionResponse) Type() protoreflect.MessageType {
	return _fastReflection_QueryCurrentAutoStakingVersionResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryCurrentAutoStakingVersionResponse) New() protoreflect.Message {
	return new(fastReflection_QueryCurrentAutoStakingVersionResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryCurrentAutoStakingVersionResponse) Interface() protoreflect.ProtoMessage {
	return (*QueryCurrentAutoStakingVersionResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryCurrentAutoStakingVersionResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Version != uint64(0) {
		value := protoreflect.ValueOfUint64(x.Version)
		if !f(fd_QueryCurrentAutoStakingVersionResponse_version, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryCurrentAutoStakingVersionResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "nova.icacontrol.v1.QueryCurrentAutoStakingVersionResponse.version":
		return x.Version != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.icacontrol.v1.QueryCurrentAutoStakingVersionResponse"))
		}
		panic(fmt.Errorf("message nova.icacontrol.v1.QueryCurrentAutoStakingVersionResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryCurrentAutoStakingVersionResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "nova.icacontrol.v1.QueryCurrentAutoStakingVersionResponse.version":
		x.Version = uint64(0)
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryCurrentAutoStakingVersionResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "nova.icacontrol.v1.QueryCurrentAutoStakingVersionResponse.version":
		value := x.Version
		return protoreflect.ValueOfUint64(value)
	default:
		...
		panic(fmt.Errorf("message nova.icacontrol.v1.QueryCurrentAutoStakingVersionResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryCurrentAutoStakingVersionResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "nova.icacontrol.v1.QueryCurrentAutoStakingVersionResponse.version":
		x.Version = value.Uint()
	default:
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryCurrentAutoStakingVersionResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "nova.icacontrol.v1.QueryCurrentAutoStakingVersionResponse.version":
		panic(fmt.Errorf("field version of message nova.icacontrol.v1.QueryCurrentAutoStakingVersionResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.icacontrol.v1.QueryCurrentAutoStakingVersionResponse"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryCurrentAutoStakingVersionResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "nova.icacontrol.v1.QueryCurrentAutoStakingVersionResponse.version":
		return protoreflect.ValueOfUint64(uint64(0))
	default:
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryCurrentAutoStakingVersionResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in nova.icacontrol.v1.QueryCurrentAutoStakingVersionResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryCurrentAutoStakingVersionResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryCurrentAutoStakingVersionResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryCurrentAutoStakingVersionResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryCurrentAutoStakingVersionResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryCurrentAutoStakingVersionResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryCurrentAutoStakingVersionResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryCurrentAutoStakingVersionResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
...
func (x *QueryIcaGrantRequest) Reset() {
	*x = QueryIcaGrantRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_nova_icacontrol_v1_query_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryIcaGrantRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryIcaGrantRequest) ProtoMessage() {}

// Deprecated: Use QueryIcaGrantRequest.ProtoReflect.Descriptor instead.
func (*QueryIcaGrantRequest) Descriptor() ([]byte, []int) {
	return file_nova_icacontrol_v1_query_proto_rawDescGZIP(), []int{4}
}

func (x *QueryIcaGrantRequest) GetZoneId() string {
	if x != nil {
		return x.ZoneId
	}
	return ""
...
func (x *QueryIcaGrantResponse) Reset() {
	*x = QueryIcaGrantResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_nova_icacontrol_v1_query_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryIcaGrantResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryIcaGrantResponse) ProtoMessage() {}

// Deprecated: Use QueryIcaGrantResponse.ProtoReflect.Descriptor instead.
func (*QueryIcaGrantResponse) Descriptor() ([]byte, []int) {
	return file_nova_icacontrol_v1_query_proto_rawDescGZIP(), []int{5}
}

func (x *QueryIcaGrantResponse) GetGrants() *AuthzGrantInfo {
	if x != nil {
		return x.Grants
	}
	return nil
...
func (*QueryAutoStakingVersion) Descriptor() ([]byte, []int) {
	return file_nova_icacontrol_v1_query_proto_rawDescGZIP(), []int{6}
}
...
func (*QueryAutoStakingVersionResponse) Descriptor() ([]byte, []int) {
	return file_nova_icacontrol_v1_query_proto_rawDescGZIP(), []int{7}
}
...
func (x *QueryCurrentAutoStakingVersion) Reset() {
	*x = QueryCurrentAutoStakingVersion{}
	if protoimpl.UnsafeEnabled {
		mi := &file_nova_icacontrol_v1_query_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryCurrentAutoStakingVersion) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (*QueryCurrentAutoStakingVersion) Descriptor() ([]byte, []int) {
	return file_nova_icacontrol_v1_query_proto_rawDescGZIP(), []int{8}
}
...
func (x *QueryCurrentAutoStakingVersionResponse) Reset() {
	*x = QueryCurrentAutoStakingVersionResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_nova_icacontrol_v1_query_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryCurrentAutoStakingVersionResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (*QueryCurrentAutoStakingVersionResponse) Descriptor() ([]byte, []int) {
	return file_nova_icacontrol_v1_query_proto_rawDescGZIP(), []int{9}
}

func (x *QueryCurrentAutoStakingVersionResponse) GetVersion() uint64 {
	if x != nil {
		return x.Version
	}
	return 0
...
var file_nova_icacontrol_v1_query_proto_rawDesc = []byte{
	...
	0x1e, 0x6e, 0x6f, 0x76, 0x61, 0x2f, 0x69, 0x63, 0x61, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c,
	0x2f, 0x76, 0x31, 0x2f, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a,
	...
	,
	...
	,
	...
	0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x32, 0xab, 0x06, 0x0a, 0x05, 0x51, 0x75,
	0x65, 0x72, 0x79, 0x12, 0x86, 0x01, 0x0a, 0x08, 0x41, 0x6c, 0x6c, 0x5a, 0x6f, 0x6e, 0x65, 0x73,
	0x12, 0x28, 0x2e, 0x6e, 0x6f, 0x76, 0x61, 0x2e, 0x69, 0x63, 0x61, 0x63, 0x6f, 0x6e, 0x74, 0x72,
	0x6f, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x41, 0x6c, 0x6c, 0x5a, 0x6f,
	0x6e, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x29, 0x2e, 0x6e, 0x6f, 0x76,
	0x61, 0x2e, 0x69, 0x63, 0x61, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x2e, 0x76, 0x31, 0x2e,
	0x51, 0x75, 0x65, 0x72, 0x79, 0x41, 0x6c, 0x6c, 0x5a, 0x6f, 0x6e, 0x65, 0x73, 0x52, 0x65, 0x73,
	...
	,
	...
	,
}
...
var file_nova_icacontrol_v1_query_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_nova_icacontrol_v1_query_proto_goTypes = []interface{}{
	...
	(*QueryIcaGrantRequest)(nil),                   // 4: nova.icacontrol.v1.QueryIcaGrantRequest
	(*QueryIcaGrantResponse)(nil),                  // 5: nova.icacontrol.v1.QueryIcaGrantResponse
	(*QueryAutoStakingVersion)(nil),                // 6: nova.icacontrol.v1.QueryAutoStakingVersion
	(*QueryAutoStakingVersionResponse)(nil),        // 7: nova.icacontrol.v1.QueryAutoStakingVersionResponse
	(*QueryCurrentAutoStakingVersion)(nil),         // 8: nova.icacontrol.v1.QueryCurrentAutoStakingVersion
	(*QueryCurrentAutoStakingVersionResponse)(nil), // 9: nova.icacontrol.v1.QueryCurrentAutoStakingVersionResponse
	(*RegisteredZone)(nil),                         // 10: nova.icacontrol.v1.RegisteredZone
	(*AuthzGrantInfo)(nil),                         // 11: nova.icacontrol.v1.AuthzGrantInfo
	(*IBCTrace)(nil),                               // 12: nova.icacontrol.v1.IBCTrace
}
var file_nova_icacontrol_v1_query_proto_depIdxs = []int32{
	10, // 0: nova.icacontrol.v1.QueryAllZonesResponse.zones:type_name -> nova.icacontrol.v1.RegisteredZone
	10, // 1: nova.icacontrol.v1.QueryZoneResponse.zone:type_name -> nova.icacontrol.v1.RegisteredZone
	11, // 2: nova.icacontrol.v1.QueryIcaGrantResponse.grants:type_name -> nova.icacontrol.v1.AuthzGrantInfo
	12, // 3: nova.icacontrol.v1.QueryAutoStakingVersionResponse.version_info:type_name -> nova.icacontrol.v1.IBCTrace
	0,  // 4: nova.icacontrol.v1.Query.AllZones:input_type -> nova.icacontrol.v1.QueryAllZonesRequest
	2,  // 5: nova.icacontrol.v1.Query.Zone:input_type -> nova.icacontrol.v1.QueryZoneRequest
	4,  // 6: nova.icacontrol.v1.Query.IcaGrant:input_type -> nova.icacontrol.v1.QueryIcaGrantRequest
	6,  // 7: nova.icacontrol.v1.Query.AutoStakingVersion:input_type -> nova.icacontrol.v1.QueryAutoStakingVersion
	8,  // 8: nova.icacontrol.v1.Query.AutoStakingCurrentVersion:input_type -> nova.icacontrol.v1.QueryCurrentAutoStakingVersion
	1,  // 9: nova.icacontrol.v1.Query.AllZones:output_type -> nova.icacontrol.v1.QueryAllZonesResponse
	3,  // 10: nova.icacontrol.v1.Query.Zone:output_type -> nova.icacontrol.v1.QueryZoneResponse
	5,  // 11: nova.icacontrol.v1.Query.IcaGrant:output_type -> nova.icacontrol.v1.QueryIcaGrantResponse
	7,  // 12: nova.icacontrol.v1.Query.AutoStakingVersion:output_type -> nova.icacontrol.v1.QueryAutoStakingVersionResponse
	9,  // 13: nova.icacontrol.v1.Query.AutoStakingCurrentVersion:output_type -> nova.icacontrol.v1.QueryCurrentAutoStakingVersionResponse
...
func file_nova_icacontrol_v1_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_nova_icacontrol_v1_query_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryIcaGrantRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_nova_icacontrol_v1_query_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryIcaGrantResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_nova_icacontrol_v1_query_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_nova_icacontrol_v1_query_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_nova_icacontrol_v1_query_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryCurrentAutoStakingVersion); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_nova_icacontrol_v1_query_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryCurrentAutoStakingVersionResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
