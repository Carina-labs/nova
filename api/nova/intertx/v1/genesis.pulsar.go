...
var (
	...
	fd_RegisteredZone_zone_name                protoreflect.FieldDescriptor
	fd_RegisteredZone_ica_connection_info      protoreflect.FieldDescriptor
	fd_RegisteredZone_transfer_connection_info protoreflect.FieldDescriptor
	...
	fd_RegisteredZone_st_denom                 protoreflect.FieldDescriptor
	fd_RegisteredZone_authz_address            protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_RegisteredZone_zone_name = md_RegisteredZone.Fields().ByName("zone_name")
	fd_RegisteredZone_ica_connection_info = md_RegisteredZone.Fields().ByName("ica_connection_info")
	fd_RegisteredZone_transfer_connection_info = md_RegisteredZone.Fields().ByName("transfer_connection_info")
	...
	fd_RegisteredZone_st_denom = md_RegisteredZone.Fields().ByName("st_denom")
	fd_RegisteredZone_authz_address = md_RegisteredZone.Fields().ByName("authz_address")
}
...
func (x *fastReflection_RegisteredZone) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.ZoneName != "" {
		...
		if !f(fd_RegisteredZone_zone_name, value) {
			return
		}
	}
	...
	if x.TransferConnectionInfo != nil {
		value := protoreflect.ValueOfMessage(x.TransferConnectionInfo.ProtoReflect())
		if !f(fd_RegisteredZone_transfer_connection_info, value) {
			return
		}
	}
	...
	if x.StDenom != "" {
		value := protoreflect.ValueOfString(x.StDenom)
		if !f(fd_RegisteredZone_st_denom, value) {
			return
		}
	}
	if x.AuthzAddress != "" {
		value := protoreflect.ValueOfString(x.AuthzAddress)
		if !f(fd_RegisteredZone_authz_address, value) {
			return
		}
	}
}
...
func (x *fastReflection_RegisteredZone) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "nova.intertx.v1.RegisteredZone.zone_name":
		return x.ZoneName != ""
	case "nova.intertx.v1.RegisteredZone.ica_connection_info":
		return x.IcaConnectionInfo != nil
	case "nova.intertx.v1.RegisteredZone.transfer_connection_info":
		return x.TransferConnectionInfo != nil
	case "nova.intertx.v1.RegisteredZone.validator_address":
		return x.ValidatorAddress != ""
	case "nova.intertx.v1.RegisteredZone.base_denom":
		return x.BaseDenom != ""
	case "nova.intertx.v1.RegisteredZone.sn_denom":
		return x.SnDenom != ""
	case "nova.intertx.v1.RegisteredZone.st_denom":
		return x.StDenom != ""
...
func (x *fastReflection_RegisteredZone) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "nova.intertx.v1.RegisteredZone.transfer_connection_info":
		value := x.TransferConnectionInfo
		return protoreflect.ValueOfMessage(value.ProtoReflect())
	case "nova.intertx.v1.RegisteredZone.validator_address":
...
func (x *fastReflection_RegisteredZone) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "nova.intertx.v1.RegisteredZone.transfer_connection_info":
		x.TransferConnectionInfo = value.Message().Interface().(*TransferConnectionInfo)
	case "nova.intertx.v1.RegisteredZone.validator_address":
	...
	case "nova.intertx.v1.RegisteredZone.st_denom":
		x.StDenom = value.Interface().(string)
	case "nova.intertx.v1.RegisteredZone.authz_address":
...
func (x *fastReflection_RegisteredZone) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "nova.intertx.v1.RegisteredZone.transfer_connection_info":
		if x.TransferConnectionInfo == nil {
			x.TransferConnectionInfo = new(TransferConnectionInfo)
		}
		return protoreflect.ValueOfMessage(x.TransferConnectionInfo.ProtoReflect())
	case "nova.intertx.v1.RegisteredZone.zone_name":
		panic(fmt.Errorf("field zone_name of message nova.intertx.v1.RegisteredZone is not mutable"))
	case "nova.intertx.v1.RegisteredZone.validator_address":
		panic(fmt.Errorf("field validator_address of message nova.intertx.v1.RegisteredZone is not mutable"))
	case "nova.intertx.v1.RegisteredZone.base_denom":
		panic(fmt.Errorf("field base_denom of message nova.intertx.v1.RegisteredZone is not mutable"))
	case "nova.intertx.v1.RegisteredZone.sn_denom":
		panic(fmt.Errorf("field sn_denom of message nova.intertx.v1.RegisteredZone is not mutable"))
	case "nova.intertx.v1.RegisteredZone.st_denom":
		panic(fmt.Errorf("field st_denom of message nova.intertx.v1.RegisteredZone is not mutable"))
	case "nova.intertx.v1.RegisteredZone.authz_address":
...
func (x *fastReflection_RegisteredZone) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if x.TransferConnectionInfo != nil {
			l = options.Size(x.TransferConnectionInfo)
			n += 1 + l + runtime.Sov(uint64(l))
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.StDenom) > 0 {
			i -= len(x.StDenom)
			copy(dAtA[i:], x.StDenom)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.StDenom)))
			i--
			dAtA[i] = 0x3a
		}
		if len(x.SnDenom) > 0 {
		...
		if x.TransferConnectionInfo != nil {
			encoded, err := options.Marshal(x.TransferConnectionInfo)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field TransferConnectionInfo", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if x.TransferConnectionInfo == nil {
					x.TransferConnectionInfo = &TransferConnectionInfo{}
				}
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.TransferConnectionInfo); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			case 4:
			...
			case 7:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field StDenom", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.StDenom = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			case 8:
				if wireType != 2 {
...
var (
	...
	fd_IcaAccount_zone_name     protoreflect.FieldDescriptor
	fd_IcaAccount_owner_address protoreflect.FieldDescriptor
	fd_IcaAccount_balance       protoreflect.FieldDescriptor
)
...
func (x *fastReflection_IcaAccount) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.ZoneName != "" {
		value := protoreflect.ValueOfString(x.ZoneName)
		if !f(fd_IcaAccount_zone_name, value) {
			return
		}
	}
	if x.OwnerAddress != "" {
		value := protoreflect.ValueOfString(x.OwnerAddress)
		if !f(fd_IcaAccount_owner_address, value) {
			return
		}
	}
	if x.Balance != nil {
		value := protoreflect.ValueOfMessage(x.Balance.ProtoReflect())
		if !f(fd_IcaAccount_balance, value) {
			return
		}
	}
}
...
var (
	...
	fd_IcaConnectionInfo_owner_address protoreflect.FieldDescriptor
)
...
func (x *fastReflection_IcaConnectionInfo) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.OwnerAddress != "" {
		value := protoreflect.ValueOfString(x.OwnerAddress)
		if !f(fd_IcaConnectionInfo_owner_address, value) {
			return
		}
	}
}
...
var (
	...
	fd_TransferConnectionInfo_connection_id protoreflect.FieldDescriptor
...
func init() {
	file_nova_intertx_v1_genesis_proto_init()
	md_TransferConnectionInfo = File_nova_intertx_v1_genesis_proto.Messages().ByName("TransferConnectionInfo")
	fd_TransferConnectionInfo_connection_id = md_TransferConnectionInfo.Fields().ByName("connection_id")
...
func (x *TransferConnectionInfo) slowProtoReflect() protoreflect.Message {
	mi := &file_nova_intertx_v1_genesis_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_TransferConnectionInfo) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.ConnectionId != "" {
		value := protoreflect.ValueOfString(x.ConnectionId)
		if !f(fd_TransferConnectionInfo_connection_id, value) {
			return
		}
	}
	if x.PortId != "" {
...
func (x *fastReflection_TransferConnectionInfo) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "nova.intertx.v1.TransferConnectionInfo.connection_id":
		return x.ConnectionId != ""
	case "nova.intertx.v1.TransferConnectionInfo.port_id":
		return x.PortId != ""
	case "nova.intertx.v1.TransferConnectionInfo.channel_id":
		return x.ChannelId != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.intertx.v1.TransferConnectionInfo"))
		}
		panic(fmt.Errorf("message nova.intertx.v1.TransferConnectionInfo does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_TransferConnectionInfo) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message nova.intertx.v1.TransferConnectionInfo does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_TransferConnectionInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "nova.intertx.v1.TransferConnectionInfo.connection_id":
		panic(fmt.Errorf("field connection_id of message nova.intertx.v1.TransferConnectionInfo is not mutable"))
	case "nova.intertx.v1.TransferConnectionInfo.port_id":
		panic(fmt.Errorf("field port_id of message nova.intertx.v1.TransferConnectionInfo is not mutable"))
	case "nova.intertx.v1.TransferConnectionInfo.channel_id":
		panic(fmt.Errorf("field channel_id of message nova.intertx.v1.TransferConnectionInfo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.intertx.v1.TransferConnectionInfo"))
		}
...
func (x *fastReflection_TransferConnectionInfo) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in nova.intertx.v1.TransferConnectionInfo", d.FullName()))
	}
	panic("unreachable")
}
...
type RegisteredZone struct {
	...
	AuthzAddress           string                  `protobuf:"bytes,8,opt,name=authz_address,json=authzAddress,proto3" json:"authz_address,omitempty"` //repeated string authz_permit = 9;
}
...
func (x *RegisteredZone) GetZoneName() string {
	if x != nil {
		return x.ZoneName
	}
	return ""
...
func (x *RegisteredZone) GetTransferConnectionInfo() *TransferConnectionInfo {
	if x != nil {
		return x.TransferConnectionInfo
	}
	return nil
}
...
func (x *RegisteredZone) GetStDenom() string {
	if x != nil {
		return x.StDenom
	}
	return ""
...
func (x *RegisteredZone) GetAuthzAddress() string {
	if x != nil {
		return x.AuthzAddress
	}
	return ""
...
func (x *IcaConnectionInfo) GetOwnerAddress() string {
	if x != nil {
		return x.OwnerAddress
	}
	return ""
...
func (*TransferConnectionInfo) Descriptor() ([]byte, []int) {
	return file_nova_intertx_v1_genesis_proto_rawDescGZIP(), []int{3}
}
...
var file_nova_intertx_v1_genesis_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x8b, 0x03, 0x0a, 0x0e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x65, 0x64,
	...
	0x65, 0x12, 0x52, 0x0a, 0x13, 0x69, 0x63, 0x61, 0x5f, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22,
	...
	0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x61, 0x0a, 0x18, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65,
	0x72, 0x5f, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x6e, 0x66,
	0x6f, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x6e, 0x6f, 0x76, 0x61, 0x2e, 0x69,
	0x6e, 0x74, 0x65, 0x72, 0x74, 0x78, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66,
	0x65, 0x72, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x66, 0x6f,
	0x52, 0x16, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x2b, 0x0a, 0x11, 0x76, 0x61, 0x6c, 0x69,
	...
	,
	...
	0x12, 0x65, 0x0a, 0x07, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x22, 0x5d, 0x0a, 0x11, 0x49, 0x63, 0x61, 0x43, 0x6f,
	...
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x75, 0x0a, 0x16, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66,
	0x65, 0x72, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x66, 0x6f,
	...
	0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x70, 0x6f, 0x72, 0x74, 0x5f, 0x69, 0x64,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x70, 0x6f, 0x72, 0x74, 0x49, 0x64, 0x12, 0x1d,
	0x0a, 0x0a, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x09, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x49, 0x64, 0x42, 0xbc, 0x01,
	0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x2e, 0x6e, 0x6f, 0x76, 0x61, 0x2e, 0x69, 0x6e, 0x74, 0x65, 0x72,
	0x74, 0x78, 0x2e, 0x76, 0x31, 0x42, 0x0c, 0x47, 0x65, 0x6e, 0x65, 0x73, 0x69, 0x73, 0x50, 0x72,
...
var file_nova_intertx_v1_genesis_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_nova_intertx_v1_genesis_proto_goTypes = []interface{}{
	...
	(*TransferConnectionInfo)(nil), // 3: nova.intertx.v1.TransferConnectionInfo
	(*v1beta1.Coin)(nil),           // 4: cosmos.base.v1beta1.Coin
}
var file_nova_intertx_v1_genesis_proto_depIdxs = []int32{
	2, // 0: nova.intertx.v1.RegisteredZone.ica_connection_info:type_name -> nova.intertx.v1.IcaConnectionInfo
	3, // 1: nova.intertx.v1.RegisteredZone.transfer_connection_info:type_name -> nova.intertx.v1.TransferConnectionInfo
	4, // 2: nova.intertx.v1.IcaAccount.balance:type_name -> cosmos.base.v1beta1.Coin
...
func file_nova_intertx_v1_genesis_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_nova_intertx_v1_genesis_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
