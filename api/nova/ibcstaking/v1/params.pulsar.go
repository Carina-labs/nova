...
func (x *_Params_1_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message Params at list field DaoModifiers as it is not of Message kind"))
}
...
func (x *_Params_2_list) Set(i int, value protoreflect.Value) {
	...
	concreteValue := valueUnwrapped.Interface().(*CommissionInfo)
	(*x.list)[i] = concreteValue
}
...
var (
	...
	fd_Params_dao_modifiers protoreflect.FieldDescriptor
	fd_Params_commission    protoreflect.FieldDescriptor
)
...
func (x *fastReflection_Params) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.DaoModifiers) != 0 {
		value := protoreflect.ValueOfList(&_Params_1_list{list: &x.DaoModifiers})
		if !f(fd_Params_dao_modifiers, value) {
			return
		}
	}
	if len(x.Commission) != 0 {
		value := protoreflect.ValueOfList(&_Params_2_list{list: &x.Commission})
		if !f(fd_Params_commission, value) {
			return
		}
	}
}
...
func (x *fastReflection_Params) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "nova.ibcstaking.v1.Params.commission":
		...
		listValue := &_Params_2_list{list: &x.Commission}
		return protoreflect.ValueOfList(listValue)
	default:
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "nova.ibcstaking.v1.Params.commission":
		...
		value := &_Params_2_list{list: &x.Commission}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: nova.ibcstaking.v1.Params"))
...
func (x *fastReflection_Params) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.DaoModifiers) > 0 {
			for iNdEx := len(x.DaoModifiers) - 1; iNdEx >= 0; iNdEx-- {
				i -= len(x.DaoModifiers[iNdEx])
				copy(dAtA[i:], x.DaoModifiers[iNdEx])
				i = runtime.EncodeVarint(dAtA, i, uint64(len(x.DaoModifiers[iNdEx])))
				i--
				dAtA[i] = 0xa
			}
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 1:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field DaoModifiers", wireType)
				}
				...
				x.DaoModifiers = append(x.DaoModifiers, string(dAtA[iNdEx:postIndex]))
				iNdEx = postIndex
			case 2:
				if wireType != 2 {
				...
				x.Commission = append(x.Commission, &CommissionInfo{})
...
var (
	md_CommissionInfo                  protoreflect.MessageDescriptor
	fd_CommissionInfo_treasury_address protoreflect.FieldDescriptor
	fd_CommissionInfo_commission_rate  protoreflect.FieldDescriptor
)
...
var _ protoreflect.Message = (*fastReflection_CommissionInfo)(nil)

type fastReflection_CommissionInfo CommissionInfo

func (x *CommissionInfo) ProtoReflect() protoreflect.Message {
	return (*fastReflection_CommissionInfo)(x)
}
...
var _fastReflection_CommissionInfo_messageType fastReflection_CommissionInfo_messageType
var _ protoreflect.MessageType = fastReflection_CommissionInfo_messageType{}

type fastReflection_CommissionInfo_messageType struct{}

func (x fastReflection_CommissionInfo_messageType) Zero() protoreflect.Message {
	return (*fastReflection_CommissionInfo)(nil)
}
func (x fastReflection_CommissionInfo_messageType) New() protoreflect.Message {
	return new(fastReflection_CommissionInfo)
}
func (x fastReflection_CommissionInfo_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_CommissionInfo
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_CommissionInfo) Descriptor() protoreflect.MessageDescriptor {
	return md_CommissionInfo
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_CommissionInfo) Type() protoreflect.MessageType {
	return _fastReflection_CommissionInfo_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_CommissionInfo) New() protoreflect.Message {
	return new(fastReflection_CommissionInfo)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_CommissionInfo) Interface() protoreflect.ProtoMessage {
	return (*CommissionInfo)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_CommissionInfo) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.TreasuryAddress != "" {
		value := protoreflect.ValueOfString(x.TreasuryAddress)
		if !f(fd_CommissionInfo_treasury_address, value) {
			return
		}
	}
	if x.CommissionRate != "" {
		value := protoreflect.ValueOfString(x.CommissionRate)
		if !f(fd_CommissionInfo_commission_rate, value) {
			return
		}
	}
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_CommissionInfo) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_CommissionInfo) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_CommissionInfo) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_CommissionInfo) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*CommissionInfo)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: CommissionInfo: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: CommissionInfo: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
// 	protoc        (unknown)
// source: nova/ibcstaking/v1/params.proto
...
var file_nova_ibcstaking_v1_params_proto_rawDesc = []byte{
	...
	,
	...
	0x3a, 0x22, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x52, 0x0f, 0x74, 0x72, 0x65, 0x61,
	0x73, 0x75, 0x72, 0x79, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x57, 0x0a, 0x0f, 0x63,
	...
	0x2e, 0x44, 0x65, 0x63, 0x52, 0x0e, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	0x52, 0x61, 0x74, 0x65, 0x42, 0xd0, 0x01, 0x0a, 0x16, 0x63, 0x6f, 0x6d, 0x2e, 0x6e, 0x6f, 0x76,
