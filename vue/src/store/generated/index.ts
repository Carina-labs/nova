...
import CarinaLabsNovachainCarinalabsNovachainNovachain from './Carina-labs/novachain/Carinalabs.novachain.novachain'
...
export default { 
  CarinaLabsNovachainCarinalabsNovachainNovachain: load(CarinaLabsNovachainCarinalabsNovachainNovachain, 'Carinalabs.novachain.novachain'),
